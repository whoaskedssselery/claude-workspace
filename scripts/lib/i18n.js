...
const STRINGS = {
	en: {
		...
		stepConfirm: 'Confirm',
		stepAlreadyInitialized: 'Already set up',
		...
		doneFolderPicking: 'Done — continue',
		...
		saveScopeQuestion: 'Save this preset for reuse?',
		saveScopeProject: 'Project → .claude-workspace/presets/, commit it, your team gets it too',
		saveScopeGlobal: 'Global → ~/.claude-workspace/presets/, just you, any project',
		saveScopeNone: 'No, just this once',
		...
		proceedYes: 'Yes → create everything above',
		proceedNo: 'No → cancel, nothing written',
		...
		alreadyInitialized: 'This project already has a claude-workspace setup (preset: {preset}). Re-run the wizard anyway?',
	...
	ru: {
		...
		stepAlreadyInitialized: 'Уже настроено',
		...
		doneFolderPicking: 'Готово — продолжить',
		...
		saveScopeQuestion: 'Сохранить этот пресет для повторного использования?',
		saveScopeProject: 'Проект → .claude-workspace/presets/, закоммитить, увидит вся команда',
		saveScopeGlobal: 'Глобально → ~/.claude-workspace/presets/, только у вас, в любом проекте',
		saveScopeNone: 'Нет, только сейчас',
		...
		proceedYes: 'Да → создать всё перечисленное выше',
		proceedNo: 'Нет → отмена, ничего не будет записано',
		...
		alreadyInitialized: 'В этом проекте уже настроен claude-workspace (пресет: {preset}). Всё равно запустить визард заново?',
