...
const STRINGS = {
	en: {
		...
		additionalSkills: 'Any additional skills to add? (space to toggle, enter to confirm)',
	...
	ru: {
		...
		additionalSkills: 'Какие дополнительные skills добавить? (пробел — выбрать, enter — продолжить)',
		domainSkillsHeader: 'Domain skills',
